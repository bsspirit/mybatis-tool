...
final public class BuildFactory {
    ...
    // public static void buildSpringService(SpringServiceXMLPO po) {
    ...
    //
    // VelocityFactory vf = new
    // VelocityFactory(VelocityFactory.CONFIG_SPRING_SERVICE_VM, map);
    ...
    //
    // VelocityFactory vf = new VelocityFactory(VelocityFactory.SQL_CREATE_VM,
    // map);
    ...
    //
    // VelocityFactory vf = new VelocityFactory(VelocityFactory.SQL_DROP_VM,
    // map);
    ...
    // map.put("author", CopyRight.AUTHOR);
    // map.put("copyright", CopyRight.COPYRIGHT);
    // map.put("timestamp", System.currentTimeMillis() + "" + new
    // Random().nextInt(3) + "L");
    ...
    //
    // VelocityFactory vf = new VelocityFactory(VelocityFactory.SERVICE_VM,
    // map);
    ...
    //
    // VelocityFactory vf = new VelocityFactory(VelocityFactory.SERVICE_IMPL_VM,
    // map);
    ...
    //
    // VelocityFactory vf = new VelocityFactory(VelocityFactory.IBATIS_SQL_VM,
    // map);
    ...
    // map.put("model_constructorMethods", mcb.getConstructorMethod());
    //
    // VelocityFactory vf = new VelocityFactory(VelocityFactory.FORM_MODEL_VM,
    // map);
    ...
    // map.put("dao_ibatis_package", pack.getIbatisPackage());
    //
    // VelocityFactory vf = new VelocityFactory(VelocityFactory.IBATIS_TEST_VM,
    // map);
